...
class AppTextFormFieldChat extends StatefulWidget {
  final double? width;
  final TextEditingController? controller;
  final bool enabled;
  final bool obscureText;
  ...
  @override
  State<AppTextFormFieldChat> createState() => _AppTextFormFieldChatState();
}

class _AppTextFormFieldChatState extends State<AppTextFormFieldChat> {
  late FocusNode _focusNode;
  late TextEditingController _controller;
  bool hasError = false;
  String errorMessage = '';
